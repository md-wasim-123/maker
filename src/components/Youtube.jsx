    ...
    return (
        <div className='w-full h-auto bg-slate-600'>
            <div class="aspect-w-10 aspect-h-4">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/HXkQq61gtg4?si=joCnGSuakxgPmIv0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
